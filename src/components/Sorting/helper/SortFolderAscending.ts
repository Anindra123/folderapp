...
import { compareFunctionAsc } from "./CompareFunctions";

export default function sortFolderAscending(
  folderArguments: FolderContextTypes
) {
  const { folders, path, setRenderFolder, setFolders } = folderArguments;
